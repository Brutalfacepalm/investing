...
class FeatureCreator:
    ...
    def __init__(self, data_as_df):
        self.eps = 1e-8
        self.df = data_as_df
        self.hours_ma = [10, 20, 30, 40, 50, 70, 140, 200, 250, 300, 350]
        ...
        self.hours_general_points = [20, 40, 80, 160, 320, 640, 1280]
        self.hours_trens = [15, 20, 25, 30, 50, 100, 150, 200, 300, 500, 1000]
        self.hours_ao = [[10, 68], [15, 102], [20, 136], [30, 204], [40, 272], [50, 340], [100, 680]]
