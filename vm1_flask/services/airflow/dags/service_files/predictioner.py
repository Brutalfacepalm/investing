...
class ExchangeTransformer(nn.Module):
    def __init__(self, device, augs, input_size, src_seq_len, batch_first,
        ...
        :param n_heads:
        :param dim_val:
        :param dropout_encoder:
        :param dropout_decoder:
        :param dim_feedforward_encoder:
        :param dim_feedforward_decoder:
        :param output_size:
        :param pred_len:
        """
        ...
        self.positional_encoding_layer = PositionEmbeddingLearned(seq_len=src_seq_len, num_pos_feats=dim_val)
        ...
        self.decoder = nn.TransformerDecoder(decoder_layer=decoder_layer,
                                             num_layers=n_decoder_layers, norm=None)
...
class LinearHead(torch.nn.Module):
    ...
    def __init__(self, device, input_size, output_size):
        ...
        self.head = torch.nn.Sequential(torch.nn.Linear(input_size, input_size // 2),
                                        torch.nn.GELU(),
                                        torch.nn.Linear(input_size // 2, output_size))
...
class PredictorPredict:
    ...
    """
    def __init__(self, device, seq_len, target_mode, log=False):
        """
        ...
        self.base_T_config = {'augs': True, 'input_size': 557, 'src_seq_len': self.seq_len,
                              'batch_first': True,
                              'n_encoder_layers': 4,
                              'n_decoder_layers': 4,
                              'n_heads': 32,
